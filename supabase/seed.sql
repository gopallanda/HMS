...
-- =============================================================================
-- Patient mix history -- so /admin/new-vs-return has a shape to show.
--
-- Five months of completed OPD visits across the three doctors, arranged so
-- every column of the report has something in it:
--
--   Dr 201   new patients who come back, two or three times each
--   Dr 202   new patients who mostly do not, and one who moves to Dr 201
--   Dr 203   a mix, including one patient who goes on to Dr 202
--
-- plus a handful in the last month, which the report correctly calls "too
-- recent" rather than "did not come back".
--
-- No consultation charge and no invoice, for the reason the block above gives:
-- these are visits settled before this system existed, and the seed does not
-- reach past collect_payment to back-date money.
--
-- Its own guard, on its own first visit id, because the block above returns
-- early on any hospital that already has history -- which is every hospital
-- this seed has run on before.
-- =============================================================================
do $$
declare
  v_hospital uuid := '00000000-0000-4000-8000-000000000001';
...
begin
  if exists (
    select 1 from public.visits v
    where v.hospital_id = v_hospital
      and v.id = '00000000-0000-4000-8000-000000000501'
  ) then
    raise notice 'seed: patient mix history already present, left alone';
    return;
  end if;

  for r in
    select * from (values
      -- Dr 201: they come back.
      ('00000000-0000-4000-8000-000000000501'::uuid, '00000000-0000-4000-8000-000000000302'::uuid, '00000000-0000-4000-8000-000000000201'::uuid, 150),
      ('00000000-0000-4000-8000-000000000502'::uuid, '00000000-0000-4000-8000-000000000302'::uuid, '00000000-0000-4000-8000-000000000201'::uuid, 136),
      ('00000000-0000-4000-8000-000000000503'::uuid, '00000000-0000-4000-8000-000000000302'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  95),
      ('00000000-0000-4000-8000-000000000504'::uuid, '00000000-0000-4000-8000-000000000304'::uuid, '00000000-0000-4000-8000-000000000201'::uuid, 120),
      ('00000000-0000-4000-8000-000000000505'::uuid, '00000000-0000-4000-8000-000000000304'::uuid, '00000000-0000-4000-8000-000000000201'::uuid, 101),
      ('00000000-0000-4000-8000-000000000506'::uuid, '00000000-0000-4000-8000-000000000304'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  62),
      ('00000000-0000-4000-8000-000000000507'::uuid, '00000000-0000-4000-8000-000000000305'::uuid, '00000000-0000-4000-8000-000000000201'::uuid, 110),
      ('00000000-0000-4000-8000-000000000508'::uuid, '00000000-0000-4000-8000-000000000305'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  90),
      ('00000000-0000-4000-8000-000000000509'::uuid, '00000000-0000-4000-8000-000000000307'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  75),
      ('00000000-0000-4000-8000-00000000050a'::uuid, '00000000-0000-4000-8000-000000000307'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  49),
      ('00000000-0000-4000-8000-00000000050b'::uuid, '00000000-0000-4000-8000-000000000311'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  58),
      ('00000000-0000-4000-8000-00000000050c'::uuid, '00000000-0000-4000-8000-000000000311'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  40),
      ('00000000-0000-4000-8000-000000000522'::uuid, '00000000-0000-4000-8000-000000000302'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  12),
      -- Dr 202: mostly one visit each, and Joseph Mathew moves to Dr 201.
      ('00000000-0000-4000-8000-00000000050d'::uuid, '00000000-0000-4000-8000-00000000030c'::uuid, '00000000-0000-4000-8000-000000000202'::uuid, 140),
      ('00000000-0000-4000-8000-00000000050e'::uuid, '00000000-0000-4000-8000-00000000030c'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  70),
      ('00000000-0000-4000-8000-00000000050f'::uuid, '00000000-0000-4000-8000-00000000030e'::uuid, '00000000-0000-4000-8000-000000000202'::uuid, 118),
      ('00000000-0000-4000-8000-000000000521'::uuid, '00000000-0000-4000-8000-00000000030e'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  20),
      ('00000000-0000-4000-8000-000000000510'::uuid, '00000000-0000-4000-8000-000000000310'::uuid, '00000000-0000-4000-8000-000000000202'::uuid, 100),
      ('00000000-0000-4000-8000-000000000511'::uuid, '00000000-0000-4000-8000-000000000310'::uuid, '00000000-0000-4000-8000-000000000201'::uuid,  92),
      ('00000000-0000-4000-8000-000000000513'::uuid, '00000000-0000-4000-8000-000000000313'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  66),
      ('00000000-0000-4000-8000-000000000514'::uuid, '00000000-0000-4000-8000-000000000313'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  55),
      ('00000000-0000-4000-8000-000000000520'::uuid, '00000000-0000-4000-8000-000000000306'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  33),
      -- Dr 203: a mix. Imran Khan starts here and later sees Dr 202; Ganesh
      -- Prabhu goes to Dr 202 nine days after his first visit.
      ('00000000-0000-4000-8000-000000000515'::uuid, '00000000-0000-4000-8000-00000000030a'::uuid, '00000000-0000-4000-8000-000000000203'::uuid, 130),
      ('00000000-0000-4000-8000-000000000516'::uuid, '00000000-0000-4000-8000-00000000030a'::uuid, '00000000-0000-4000-8000-000000000203'::uuid, 118),
      ('00000000-0000-4000-8000-000000000517'::uuid, '00000000-0000-4000-8000-00000000030a'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  60),
      ('00000000-0000-4000-8000-000000000518'::uuid, '00000000-0000-4000-8000-000000000314'::uuid, '00000000-0000-4000-8000-000000000203'::uuid, 105),
      ('00000000-0000-4000-8000-000000000519'::uuid, '00000000-0000-4000-8000-000000000314'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  88),
      ('00000000-0000-4000-8000-000000000512'::uuid, '00000000-0000-4000-8000-000000000314'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  80),
      ('00000000-0000-4000-8000-00000000051a'::uuid, '00000000-0000-4000-8000-00000000030b'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  85),
      ('00000000-0000-4000-8000-00000000051b'::uuid, '00000000-0000-4000-8000-00000000030b'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  78),
      ('00000000-0000-4000-8000-00000000051c'::uuid, '00000000-0000-4000-8000-000000000312'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  70),
      ('00000000-0000-4000-8000-00000000051d'::uuid, '00000000-0000-4000-8000-000000000312'::uuid, '00000000-0000-4000-8000-000000000202'::uuid,  61),
      ('00000000-0000-4000-8000-00000000051e'::uuid, '00000000-0000-4000-8000-00000000030f'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  45),
      ('00000000-0000-4000-8000-00000000051f'::uuid, '00000000-0000-4000-8000-000000000309'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,  35),
      ('00000000-0000-4000-8000-000000000523'::uuid, '00000000-0000-4000-8000-000000000305'::uuid, '00000000-0000-4000-8000-000000000203'::uuid,   8)
    ) as t(id, patient_id, doctor_id, days_ago)
    order by days_ago desc
  loop
    v_visit := public.create_visit(jsonb_build_object(
      'id',                r.id,
    ...
    -- Over and done with, like every past visit. set_visit_status rather than
    -- save_consultation: nobody wrote a note on these, and a blank one would
    -- be a consultation that never happened.
    perform public.set_visit_status(v_visit.id, 'completed', v_hospital);
    v_count := v_count + 1;
  end loop;

  raise notice 'seed: % visits of patient mix history', v_count;
end;
$$;
